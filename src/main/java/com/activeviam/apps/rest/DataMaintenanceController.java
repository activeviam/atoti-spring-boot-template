 ...
 * corrupt, since nothing is ever written anywhere. Phase 4: operates on the single {@code TradesMerged}
 * table (the merged replacement for the two-table {@code Trades}/{@code TradeAttributes} model) - since
 * there is no join at all here, the refresh scoping has no join-related caveats to consider either.
 *
