 ...
 */
package com.activeviam.apps.cfg.datamodel;
...
import com.activeviam.activepivot.copper.avinternal.motherboard.core.configurator.IDatastoreConfigurator;
import com.activeviam.activepivot.server.spring.avinternal.motherboard.core.config.IDatastoreSetupHandler;
...
public class DataModelConfiguration {
    ...
    @Bean
    IDatastoreSetupHandler datastoreSetupHandler() {
        return DataModelConfiguration::configureDatastore;
    }

    private static void configureDatastore(IDatastoreConfigurator configurator) {
        configurator
                .addTable(StoreDescription.builder()
                ...
                .addTable(StoreDescription.builder()
                        ...
                        .build())
                .addJoin(ReferenceDescription.builder()
